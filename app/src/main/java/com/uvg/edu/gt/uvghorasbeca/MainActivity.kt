...
fun MyApp() {
    ...
    Scaffold(
        topBar = { TopAppBar() }, // Usar TopAppBar aquí
        bottomBar = { BottomNavigationBar(navController) }  // Usar BottomNavigationBar aquí
    ) { innerPadding ->
        NavHost(
            navController = navController,
            startDestination = "home",  // Aquí defines la ruta inicial
